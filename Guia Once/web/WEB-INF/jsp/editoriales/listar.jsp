            ...
            <div class="row">
                <div class="col-md-10">
                    <a class="btn btn-primary btn-md" href="<s:url 
                       value="/editoriales/create"/>"><s:message code="editorial.nuevo"/></a>
                    <br><br>
                            ...
                            <tr>
                                ...
                                <td> 
                                    <a class="btn btn-primary" href="<s:url value="/editoriales/edit/${editorial.codigoEditorial}"/>">
                                       ...
                                       <a class="btn btn-primary" href="javascript:eliminar('${editorial.codigoEditorial}')">
                                       <span class="glyphicon glyphicon-trash"></span><s:message code="eliminar"/></a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
